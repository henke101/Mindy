...
//	ThreePosItem[] threePosItemList = { new ThreePosItem("En jŠkligt bra sak", "JodŒ, jag lovar", "Just precis!"), new ThreePosItem("En Bra Sak", "En Annan Bra Sak", "Och Ytterliggare En Bra Sak") };
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		/**
		 * Skriver ut logcat men nästaknappen fungerar ej
		 */
		inputOne.setOnEditorActionListener(new OnEditorActionListener(){
			...
			public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
		        ...
		        if (actionId == EditorInfo.IME_ACTION_NEXT) {
		        	...
		        	Log.d("String ", "Skriver ut första: " + stringInputOne);
		        	inputOne.clearFocus();
